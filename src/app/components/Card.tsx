...
interface CardProps {
    ...
    isWide?: boolean;
    isSmall?: boolean;
    onLargeCardButtonClick?: () => void; // 新增回调函数
}
...
const Card: React.FC<CardProps> = ({
    ...
    return (
        <div
            className={`relative bg-white rounded-extra-large shadow-md overflow-hidden transition-transform transition-shadow duration-500 ease-in-out transform hover:scale-105 hover:shadow-2xl ${className}`}
        >
            {imageUrl && (
                <Image
                    src={imageUrl}
