...
const SEOContent: React.FC<SEOContentProps> = ({ onStartQRCode, showOnlyHeader, showOnlyContent }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white">
            {/* 主标题 - 包含核心关键词 */}
            <header id="home" className="text-center mb-8">
                ...
                <div className="mb-8">
                    <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-200 shadow-lg text-lg"
                    >
                        🚀 Start Creating QR Codes
                    </button>
                    <p className="text-sm text-gray-500 mt-2">Free • No Registration Required • Instant Generation</p>
                </div>
            </header>
