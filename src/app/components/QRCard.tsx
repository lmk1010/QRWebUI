                        ...
                        <div className="grid grid-cols-3 gap-3">
                            ...
                            >
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="text-xs text-gray-400 mt-0.5">Custom Style</div>
                                </div>
                            </button>
                            <button
                                className="p-2.5 text-center bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
                    ...
                    {(selectedMainType === 'text' || selectedMainType === 'url') && (
                        <div className="mt-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                            <div className="flex items-center mb-3">
                                ...
                                <h3 className="text-base font-semibold text-gray-800">Customization Features</h3>
                            </div>
                            
                            <div className="space-y-3">
                                <div className="flex items-start space-x-2">
                                    <div className="w-5 h-5 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                        <FaRulerCombined className="w-2.5 h-2.5 text-purple-600" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800 text-sm mb-0.5">Dot Style</h4>
                                ...
                                <div className="flex items-start space-x-2">
                                    <div className="w-5 h-5 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                        <FaFile className="w-2.5 h-2.5 text-green-600" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800 text-sm mb-0.5">Logo Embedding</h4>
                                ...
                                <div className="flex items-start space-x-2">
                                    <div className="w-5 h-5 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                        <FaPalette className="w-2.5 h-2.5 text-orange-600" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800 text-sm mb-0.5">Color Customization</h4>
                                        <p className="text-xs text-gray-600">Freely choose foreground and background colors to create professional QR codes.</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div className="mt-3 p-2.5 bg-white/60 rounded-lg border border-blue-200">
