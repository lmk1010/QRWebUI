            ...
            {selectedSubType && (
                <div className="w-full max-w-md mb-6 mt-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-2">
                        <input
                            type="text"
                            className="w-full sm:w-2/3 p-2 border border-gray-300 rounded-l-md focus:ring-2 focus:ring-blue-500"
                            placeholder="e.g., link, text, file URL, etc."
                            value={customText}
                            onChange={(e) => setCustomText(e.target.value)}
                        />
                        <button
                            className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors w-full sm:w-1/3"
